...
class AddInteriorBlindsAndControl < OpenStudio::Measure::ModelMeasure
  ...
  def modeler_description
    return 'The measure will create a new interior blinds shading control object and loop through all exterior windows add the shading control with blinds.'
  end
  ...
  def run(model, runner, user_arguments)
    ...
    shading_control.setShadingType("InteriorBlind")
    shading_control.setName("Interior blinds shading control")
    ...
    runner.registerInfo("New schedule 'Interior blinds schedule' has been created for shading control object #{shading_control.name}")
    ...
    runner.registerInfo("#{windows_applied} exterior windows have been applied with interior blinds shading")
    return true
  end
end
