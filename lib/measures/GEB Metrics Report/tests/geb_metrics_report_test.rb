...
class GEBMetricsReportTest < Minitest::Test
  ...
  def epw_path_default
    ...
    epw = File.expand_path("#{File.dirname(__FILE__)}/CZ06RV2.epw")
  ...
  def test_geb_metrics_report
    test_name = 'run_geb_measures'

    # create an instance of the measure
    measure = GEBMetricsReport.new
    ...
    args_hash = {}
    args_hash['baseline_run_output_path'] = File.dirname(__FILE__ )
    args_hash['event_date'] = '07-21'
    args_hash['shed_start'] = '13:00'
    args_hash['shed_end'] = '15:00'
    args_hash['take_start'] = '10:00'
    args_hash['take_end'] = '13:00'
