...
RSpec.describe OpenStudio::Geb do
  ...
  it "can apply and run single measure" do
    ...
    baseline_dir_str = File.join(File.dirname(__FILE__ ), "../seed_models/Hospital.osm")   # commercial
    ...
    weather_file_path = File.join(File.dirname(__FILE__ ), "../seed_models/USA_OK_Oklahoma.City-Tinker.AFB.723540_TMY3.epw")
    measure_dict = {
